...
function MapModal() {
  return (
    <div className="absolute left-0 top-[50px] z-[1200] flex w-[264px] flex-col items-center rounded-[10px] border-[1px] border-solid border-[#c4c4c4] bg-white px-1 py-[9px]">
